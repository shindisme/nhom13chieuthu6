...
const fmtDate = (iso) =>
  iso ? new Date(iso).toLocaleString("vi-VN", { day: "2-digit", month: "2-digit", year: "numeric" }) : "—";

function ChamCongDeleteConfirm({ record, onClose, onDeleted }) {
...
export default ChamCongDeleteConfirm;
